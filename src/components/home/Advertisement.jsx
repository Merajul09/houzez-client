            ...
            <Link to={`/property/${property?._id}`} className='cursor-pointer group'>
                <div className="cursor-pointer rounded-xl bg-white p-3 shadow-lg hover:shadow-xl">
                    <div className="relative flex items-end overflow-hidden rounded-xl">
                        <img src={property.image} alt="wallpaper" className='object-cover h-full w-full group-hover:scale-110 transition' />
                    ...
                    <div className="mt-1 p-2">
                        ...
                        <div className="mt-3 flex items-end justify-between">
                            ...
                            <div className="group inline-flex">
                                <p className="text-lg font-bold text-green-500">{users.status}</p>
                            </div>
                        </div>
                    </div>
                </div>
